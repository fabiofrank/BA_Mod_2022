...
datei1 = r'C:\Users\fabio\PycharmProjects\BA_Mod\Outputdateien\BadCase_ohneDWPT.xlsx'

(x1, y1) = uhrzeit_soc_array(datei1)

plt.plot_date(x1, y1, '.-', markevery=900)
...
fig.savefig(r'C:\Users\fabio\PycharmProjects\BA_Mod\Outputdateien\SoC_BadCase.pgf')
